...
const tools = [
  ...
  { name: 'JavaScript Minifier', slug: '/javascript-minifier' },
  { name: 'CSS Generator', slug: '/css-generator' },
    ...
    >
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <span className="text-lg font-bold" style={{ color: 'var(--color-footer-text)' }}>DeveloperTools.one</span>
            </div>
            <p className="text-sm leading-relaxed" style={{ color: 'var(--color-footer-muted)' }}>Free online developer tools. JSON formatter, regex tester, Base64 encoder, and more. 100% client-side processing.</p>
          </div>
        ...
        <div className="mt-8 pt-8 text-center text-sm" style={{ borderTop: '1px solid var(--color-footer-border)', color: 'var(--color-footer-muted)' }}>
          &copy; {new Date().getFullYear()} DeveloperTools.one. All rights reserved.
        </div>
      </div>
    </footer>
  );
