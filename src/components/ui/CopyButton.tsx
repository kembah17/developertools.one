...
export default function CopyButton({ text, label = "Copy" }: { text: string; label?: string }) {
  ...
  return (
    <button onClick={handleCopy} className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium bg-primary hover:bg-primary-dark text-surface rounded-lg transition-colors">
      {copied ? (
