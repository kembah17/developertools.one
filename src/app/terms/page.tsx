...
export const metadata: Metadata = {
  title: "Terms of Service — DeveloperTools.one",
  description: "Terms of service for DeveloperTools.one. Free developer tools provided as-is with 100% client-side processing.",
};
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="space-y-6 text-text-light dark:text-text-dark-muted leading-relaxed">
        <section>
          ...
          <p>By accessing and using DeveloperTools.one (the &quot;Service&quot;), you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use the Service.</p>
        </section>

        <section>
          <h2 className="text-2xl font-bold text-text dark:text-text-dark mb-3">2. Description of Service</h2>
          <p>DeveloperTools.one provides free, browser-based developer tools including but not limited to JSON formatting, regex testing, Base64 encoding/decoding, URL encoding/decoding, HTML formatting, CSS generation, JavaScript minification, SQL formatting, cron expression generation, JWT decoding, UUID generation, and hash generation. All tools operate entirely within your web browser using client-side JavaScript.</p>
        </section>

        <section>
          <h2 className="text-2xl font-bold text-text dark:text-text-dark mb-3">3. Client-Side Processing</h2>
          <p>All data processing on DeveloperTools.one occurs locally in your web browser. No data you input into our tools is transmitted to, processed by, or stored on our servers. You are solely responsible for the data you process and the results you obtain.</p>
        </section>

        <section>
          <h2 className="text-2xl font-bold text-text dark:text-text-dark mb-3">4. Use of Service</h2>
          <p>You may use DeveloperTools.one for any lawful purpose. You agree not to:</p>
        ...
        <section>
          ...
          <p>The DeveloperTools.one website, including its design, code, content, and branding, is protected by intellectual property laws. You may not reproduce, distribute, or create derivative works from our content without permission. The tools themselves are provided for your free use as described in these terms.</p>
        </section>

        <section>
          <h2 className="text-2xl font-bold text-text dark:text-text-dark mb-3">6. Disclaimer of Warranties</h2>
          <p>DeveloperTools.one is provided &quot;as is&quot; and &quot;as available&quot; without warranties of any kind, either express or implied. We do not warrant that:</p>
          <ul className="list-disc pl-6 space-y-1 mt-2">
        ...
        <section>
          ...
          <p>To the fullest extent permitted by law, DeveloperTools.one and its operators shall not be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues, whether incurred directly or indirectly, or any loss of data, use, goodwill, or other intangible losses resulting from your use of the Service.</p>
        </section>

        <section>
          <h2 className="text-2xl font-bold text-text dark:text-text-dark mb-3">8. Advertising</h2>
          <p>DeveloperTools.one is supported by advertising. By using the Service, you acknowledge that advertisements may be displayed alongside our tools. We strive to ensure ads do not interfere with tool functionality.</p>
        </section>
